  ...
  return (
    <SectionContainer delay={0.2} className="py-24 md:py-32 relative overflow-hidden bg-surface-container-lowest">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        <SectionHeader
          badgeText={t.badge}
          badgeIcon={<Sparkles className="w-3.5 h-3.5 text-primary mr-2" />}
          titleNode={
            <>
          ...
          titleClassName="max-w-3xl lg:text-headline-xl mx-auto"
          ...
          {insights.map((item) => {
            ...
            return (
              <motion.div
                ...
                className={cn(
                  "relative cursor-pointer transition-all duration-700 will-change-transform h-full",
                  isActive ? "z-10" : "z-0"
                )}
              >
                <Card 
                  className={cn(
                    ...
                    isActive ? 'border-primary/30 shadow-2xl shadow-primary/5' : 'border-white/5'
                  )}
                ...
                >
                  ...
                  >
                    ...
                    <div className={cn(
                      "absolute inset-0 bg-linear-to-t transition-opacity duration-1000",
                      isActive ? 'from-background via-background/40 to-transparent opacity-100' : 'from-background via-background/80 to-background/40 opacity-100'
                    )} />
                  </motion.div>
                  ...
                  <div className="absolute inset-0 flex flex-col justify-end p-6 md:p-8 lg:p-10 z-10 pointer-events-none">
                    ...
                    <div className={cn(
                      "absolute top-6 right-6 lg:top-8 lg:right-8 w-12 h-12 rounded-full border bg-surface-container-highest/80 backdrop-blur-3xl flex items-center justify-center transition-all duration-700 overflow-hidden shrink-0",
                      isActive ? 'border-primary/20 opacity-100 scale-100' : 'border-transparent opacity-0 scale-75'
                    )}>
                      {item.icon}
                    </div>
